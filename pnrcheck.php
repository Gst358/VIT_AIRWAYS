...
<center><img src='images/jet.jpg' class='img-thumbnail' width='1200px' style='height:80px;' style="border-radius:150px;"></center>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <center><font style="font-family:Arial Black; font-size:20px;">
                   ...
                   $row1 = mysqli_fetch_array($result1)  ; 
                        ...
                        echo "<center><img src='images/vit.png' class='img-thumbnail' width='180px' style='height:180px;border-radius:150px;'></center>";
                   ?>
                        </td>
                 </tr>   
